 ...
 */
class Button {
    constructor(klass = null, onClick = null, label = null, icon = null, labelKey = null, titleKey = null) {
        this.klass = klass;
    ...
    static appendClasses(button, newClasses) {
        ...
        if (button.klass instanceof Object) {
            const classes = Object.assign({}, button.klass);
    ...
    addClasses(newClasses) {
        ...
        if (this.klass instanceof Object) {
            const classes = Object.assign({}, this.klass);
            classes[newClasses.join(' ')] = true;
            this.klass = classes;
        }
    }
...
class OverridableMap {
    ...
    getGroupEntries(group) {
        const values = {};
        const allValues = Object.assign({}, this.map.default.values);
        let groupEntry = {
            values: {},
            exclude: []
        };
...
RecordMapperRegistry.ɵfac = function RecordMapperRegistry_Factory(t) { return new (t || RecordMapperRegistry)(); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RecordMapperRegistry, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
