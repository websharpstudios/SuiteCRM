...
export declare type TextSizes = 'regular' | 'medium' | 'large' | 'x-large' | 'xx-large' | 'huge' | string;
export declare type ContentJustify = 'start' | 'end' | 'center' | 'between' | 'around' | string;
export declare type ContentAlign = 'start' | 'end' | 'center' | 'baseline' | 'stretch' | string;
export declare type TextColor = 'yellow' | 'blue' | 'green' | 'red' | 'purple' | 'dark' | 'grey' | string;
