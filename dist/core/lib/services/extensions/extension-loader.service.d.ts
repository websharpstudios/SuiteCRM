...
export declare class ExtensionLoader {
    ...
    constructor(systemConfigStore: SystemConfigStore, compiler: Compiler);
    /**
     * Load all extensions
     *
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ExtensionLoader, never>;
}
export {};

//# sourceMappingURL=extension-loader.service.d.ts.map