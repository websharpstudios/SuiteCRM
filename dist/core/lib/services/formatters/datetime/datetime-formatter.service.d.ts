...
export declare class DatetimeFormatter implements Formatter {
    ...
    formatDateTime(dateString: string, format: string, fromFormat?: string): string;
    toDateTime(datetimeString: string, fromFormat?: string): DateTime;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DatetimeFormatter, never>;
}

//# sourceMappingURL=datetime-formatter.service.d.ts.map