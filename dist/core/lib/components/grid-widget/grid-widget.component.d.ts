...
export declare class GridWidgetComponent implements OnInit, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<GridWidgetComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<GridWidgetComponent, "scrm-grid-widget", never, { "config": "config"; }, {}, never, never>;
}
export {};

//# sourceMappingURL=grid-widget.component.d.ts.map