...
export interface NavbarModel {
    ...
    current?: MenuItem;
    resetMenu(): void;
    build(navigation: Navigation, languages: LanguageStrings, userPreferences: UserPreferenceMap, currentUser: CurrentUserModel, appState: AppState, itemThreshold: number): void;
