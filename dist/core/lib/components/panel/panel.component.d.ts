...
export declare class PanelComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PanelComponent, "scrm-panel", never, { "klass": "klass"; "bodyPadding": "bodyPadding"; "mode": "mode"; "close": "close"; "title": "title"; "titleKey": "titleKey"; "isCollapsed$": "isCollapsed$"; }, {}, never, ["[panel-icon-area]", "[panel-header-button]", "[panel-body]"]>;
}
