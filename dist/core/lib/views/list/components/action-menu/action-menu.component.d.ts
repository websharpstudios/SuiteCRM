...
export declare class ActionMenuComponent implements OnInit {
    ...
    constructor(listStore: ListViewStore, actionHandler: ModuleNavigation, screenSize: ScreenSizeObserverService, systemConfigs: SystemConfigStore);
    ngOnInit(): void;
    getButtonGroupConfig(): ButtonGroupInterface;
    getBreakpoint(): number;
    get actions(): ModuleAction[];
    getButtonConfig(action: ModuleAction): ButtonInterface;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ActionMenuComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ActionMenuComponent, "scrm-action-menu", never, {}, {}, never, never>;
}
