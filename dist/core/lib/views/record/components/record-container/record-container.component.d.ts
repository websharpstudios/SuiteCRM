...
export declare class RecordContainerComponent implements OnInit {
    ...
    constructor(recordViewStore: RecordViewStore, language: LanguageStore, metadata: MetadataStore, contentAdapter: RecordContentAdapter, topWidgetAdapter: TopWidgetAdapter, sidebarWidgetAdapter: SidebarWidgetAdapter);
    ngOnInit(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<RecordContainerComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<RecordContainerComponent, "scrm-record-container", never, {}, {}, never, never>;
}
