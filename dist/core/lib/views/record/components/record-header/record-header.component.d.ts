...
export declare class RecordHeaderComponent implements OnInit, OnDestroy {
    ...
    constructor(actionsAdapter: RecordActionsAdapter, recordViewStore: RecordViewStore, moduleNavigation: ModuleNavigation);
    ngOnInit(): void;
    ngOnDestroy(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<RecordHeaderComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<RecordHeaderComponent, "scrm-record-header", never, {}, {}, never, never>;
}
