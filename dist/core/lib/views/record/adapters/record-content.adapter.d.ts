...
export declare class RecordContentAdapter implements RecordContentDataSource {
    ...
    inlineEdit: true;
    constructor(store: RecordViewStore, metadata: MetadataStore, language: LanguageStore, actions: RecordActionManager);
    getEditAction(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<RecordContentAdapter, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<RecordContentAdapter>;
}
