...
export declare class SavedFilterActionAdapterFactory {
    ...
    constructor(language: LanguageStore, actionManager: SavedFilterActionManager, asyncActionService: AsyncActionService, message: MessageService, confimation: ConfirmationModalService, selectModalService: SelectModalService);
    create(store: SavedFilterStore, listFilterStore: ListFilterStore): SavedFilterActionsAdapter;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<SavedFilterActionAdapterFactory, never>;
}
