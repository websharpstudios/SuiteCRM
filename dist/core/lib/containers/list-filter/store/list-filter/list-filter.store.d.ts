...
import { ButtonInterface, DropdownButtonInterface, Field, SearchMetaFieldMap } from 'common';
...
export declare class ListFilterStore implements StateStore {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ListFilterStore, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<ListFilterStore>;
}

//# sourceMappingURL=list-filter.store.d.ts.map