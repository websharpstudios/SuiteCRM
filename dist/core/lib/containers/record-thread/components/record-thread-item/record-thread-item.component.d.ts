...
export declare class RecordThreadItemComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<RecordThreadItemComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<RecordThreadItemComponent, "scrm-record-thread-item", never, { "config": "config"; }, {}, never, never>;
}

//# sourceMappingURL=record-thread-item.component.d.ts.map