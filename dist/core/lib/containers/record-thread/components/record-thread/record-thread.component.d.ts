...
export declare class RecordThreadComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(storeFactory: RecordThreadStoreFactory, itemFactory: RecordThreadItemStoreFactory, recordManager: RecordManager, message: MessageService);
    ngOnInit(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<RecordThreadComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<RecordThreadComponent, "scrm-record-thread", never, { "config": "config"; }, {}, never, never>;
}

//# sourceMappingURL=record-thread.component.d.ts.map