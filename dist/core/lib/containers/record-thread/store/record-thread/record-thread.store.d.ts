...
import { Record, SearchCriteria } from 'common';
...
export declare class RecordThreadStore extends RecordStoreList<RecordThreadItemStore, RecordThreadItemMetadata> {
    ...
    getMetadata(): RecordThreadItemMetadata;
    setMetadata(meta: RecordThreadItemMetadata): RecordThreadItemMetadata;
    allLoaded(): boolean;
    loadMore(jump?: number): void;
    reload(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<RecordThreadStore, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<RecordThreadStore>;
}

//# sourceMappingURL=record-thread.store.d.ts.map