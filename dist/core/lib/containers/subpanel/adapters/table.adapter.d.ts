...
export declare class SubpanelTableAdapter {
    ...
    constructor(store: SubpanelStore, lineActionsAdapterFactory: SubpanelLineActionsAdapterFactory);
    getTable(): TableConfig;
    protected getColumns(): Observable<ColumnDefinition[]>;
    protected getLineActions(): ActionDataSource;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<SubpanelTableAdapter, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<SubpanelTableAdapter>;
}
