...
export declare class SubpanelActionManager {
    ...
    constructor(create: SubpanelCreateAction, select: SubpanelSelectAction, async: AsyncProcessSubpanelAction);
    run(action: string, data: SubpanelActionData): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<SubpanelActionManager, never>;
}
