...
export declare class SubpanelComponent implements OnInit {
    ...
    constructor(actionManager: SubpanelActionManager, languages: LanguageStore, tableAdapterFactory: SubpanelTableAdapterFactory);
    ngOnInit(): void;
    buildAction(): any;
    getButtonGroupConfig(actions: Action[]): ButtonGroupInterface;
    protected buildButton(action: Action): AnyButtonInterface;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<SubpanelComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<SubpanelComponent, "scrm-subpanel", never, { "store": "store"; "maxColumns$": "maxColumns$"; }, {}, never, never>;
}

//# sourceMappingURL=subpanel.component.d.ts.map