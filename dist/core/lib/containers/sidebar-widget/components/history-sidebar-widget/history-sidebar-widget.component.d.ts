...
export declare class HistorySidebarWidgetComponent extends BaseWidgetComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(historyTimelineAdapterFactory: HistoryTimelineAdapterFactory, languageStore: LanguageStore);
    ngOnInit(): void;
     ...
     */
    onScroll(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<HistorySidebarWidgetComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<HistorySidebarWidgetComponent, "scrm-history-timeline-widget", never, {}, {}, never, never>;
}

//# sourceMappingURL=history-sidebar-widget.component.d.ts.map