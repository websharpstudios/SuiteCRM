...
export declare class FieldComponent implements OnInit {
    ...
    class: string;
    map: import("./field.model").FieldComponentMap;
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<FieldComponent, "scrm-field", never, { "record": "record"; "klass": "klass"; "mode": "mode"; "type": "type"; "field": "field"; }, {}, never, never>;
}
