...
export declare class DateTimeFilterFieldComponent extends BaseDateTimeComponent implements OnInit, OnDestroy {
    ...
    constructor(formatter: DatetimeFormatter, typeFormatter: DataTypeFormatter, calendar: NgbCalendar, config: NgbPopoverConfig, logic: FieldLogicManager);
    ngOnInit(): void;
    ngOnDestroy(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DateTimeFilterFieldComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<DateTimeFilterFieldComponent, "scrm-datetime-filter", never, {}, {}, never, never>;
}
