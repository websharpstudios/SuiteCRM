...
export declare class BaseRelateComponent extends BaseFieldComponent implements OnInit, OnDestroy {
    ...
    initModule: string;
    constructor(languages: LanguageStore, typeFormatter: DataTypeFormatter, relateService: RelateService, moduleNameMapper: ModuleNameMapper, logic: FieldLogicManager);
    get module(): string;
    ngOnInit(): void;
    ngOnDestroy(): void;
    onModuleChange(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<BaseRelateComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<BaseRelateComponent, "ng-component", never, {}, {}, never, never>;
}

//# sourceMappingURL=base-relate.component.d.ts.map