...
class getUpgradePackageHandlerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Install\\Service\\Upgrade\\UpgradePackageHandler'] = new \App\Install\Service\Upgrade\UpgradePackageHandler(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/tmp/package/upgrade'), new \App\Engine\Service\FolderSync\FolderSync(), new \App\Engine\Service\FolderSync\FolderComparator(), ($container->services['monolog.logger.upgrade'] ?? $container->load('getMonolog_Logger_UpgradeService')), $container->parameters['upgrades']);
    }
}
