...
class getNavbarItemDataProviderService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Navbar\\DataProvider\\NavbarItemDataProvider'] = new \App\Navbar\DataProvider\NavbarItemDataProvider(($container->privates['App\\Navbar\\LegacyHandler\\NavbarHandler'] ?? $container->load('getNavbarHandlerService')), ($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService')));
    }
}
