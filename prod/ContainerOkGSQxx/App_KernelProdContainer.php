...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Security/EventListener/DenyAccessListener.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Security/Core/Authorization/ExpressionLanguageProvider.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/doctrine/event-manager/lib/Doctrine/Common/EventManager.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Routing/Router.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Api/IriConverterInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/OperationDataProviderTrait.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Util/ResourceClassInfoTrait.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Routing/IriConverter.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Routing/RouteNameResolverInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Cache/CachedTrait.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Routing/CachedRouteNameResolver.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Routing/RouteNameResolver.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Routing/RouterOperationPathResolver.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/EventListener/AddFormatListener.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/ToggleableOperationAttributeTrait.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/EventListener/ReadListener.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/EventListener/DeserializeListener.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Api/IdentifiersExtractorInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Api/CachedIdentifiersExtractor.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Api/IdentifiersExtractor.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Identifier/IdentifierConverterInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Identifier/ContextAwareIdentifierConverterInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Identifier/IdentifierConverter.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Operation/Factory/SubresourceOperationFactoryInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Operation/Factory/CachedSubresourceOperationFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Operation/Factory/SubresourceOperationFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/ItemDataProviderInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/ChainItemDataProvider.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/CollectionDataProviderInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/ContextAwareCollectionDataProviderInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/ChainCollectionDataProvider.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/SubresourceDataProviderInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/DataProvider/ChainSubresourceDataProvider.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/AnnotationResourceNameCollectionFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/ResourceMetadataFactoryInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/CachedResourceMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/FormatsResourceMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/OperationResourceMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Util/AnnotationFilterExtractorTrait.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/AnnotationResourceFilterMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/ShortNameResourceMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/PhpDocResourceMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/InputOutputResourceMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/ExtractorResourceMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Resource/Factory/AnnotationResourceMetadataFactory.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/PropertyInfo/Metadata/Property/PropertyInfoPropertyNameCollectionFactory.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Validator/Metadata/Property/ValidatorPropertyMetadataFactory.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Property/Factory/AnnotationPropertyMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Property/Factory/AnnotationSubresourceMetadataFactory.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Doctrine/Orm/Metadata/Property/DoctrineOrmPropertyMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/PropertyInfo/Metadata/Property/PropertyInfoPropertyMetadataFactory.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Extractor/ExtractorInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Extractor/AbstractExtractor.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Extractor/XmlExtractor.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Metadata/Extractor/YamlExtractor.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Bundle/EventListener/SwaggerUiListener.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/EventListener/QueryParameterValidateListener.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Api/FilterLocatorTrait.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Filter/QueryParameterValidator.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Security/ResourceAccessCheckerInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Security/ResourceAccessChecker.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Swagger/Serializer/ApiGatewayNormalizer.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Swagger/Serializer/DocumentationNormalizer.php';
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        $k = ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService());

        $l = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($f, $g, $h, ($this->privates['api_platform.hydra.json_schema.schema_factory'] ?? $this->getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()), ($this->privates['api_platform.json_schema.type_factory'] ?? $this->getApiPlatform_JsonSchema_TypeFactoryService()), ($this->privates['api_platform.operation_path_resolver.router'] ?? $this->getApiPlatform_OperationPathResolver_RouterService()), NULL, $i, NULL, true, 'oauth2', 'password', '/oauth/v2/token', '/oauth/v2/auth', [], [], $j, true, 'page', false, 'itemsPerPage', $this->parameters['api_platform.formats'], false, 'pagination', [], $this->parameters['api_platform.swagger.versions'], $k, $d));
        $m = ($this->privates['api_platform.router'] ?? $this->getApiPlatform_RouterService());
        $n = ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService());
        ...
        $s = ($this->privates['api_platform.security.resource_access_checker'] ?? $this->getApiPlatform_Security_ResourceAccessCheckerService());
        $t = ($this->privates['api_platform.item_data_provider'] ?? $this->getApiPlatform_ItemDataProviderService());
        $u = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($r, $n, $a, $b, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($r), NULL, []);

        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => $e, 2 => $l, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($m, [], $n), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $n), 5 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ValidationExceptionNormalizer($this->parameters['api_platform.exception_to_status']), 6 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\HttpExceptionNormalizer(), 7 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\RuntimeExceptionNormalizer(), 8 => $l, 9 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ErrorNormalizer(), 10 => $e, 11 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $o, NULL, $m, $j, $n), 12 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $p, $m), 13 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($m, false), 14 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(false), 15 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false), 16 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 17 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $p, $o, $q, $a, $n, $r, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $s), 18 => new \ApiPlatform\Core\GraphQl\Serializer\ItemNormalizer($g, $h, $p, $k, $o, $a, $n, $r, $t, false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f), 19 => new \ApiPlatform\Core\Serializer\ItemNormalizer($g, $h, $p, $o, $a, $n, $r, $t, false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f, $s), 20 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $n), 23 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 25 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 26 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 27 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($q, $o, $p), 'page', 'pagination', $f, $a), $f, $o, $i), 28 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 29 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($u, $p, $q), 30 => new \ApiPlatform\Core\GraphQl\Serializer\ObjectNormalizer($u, $p, $k), 31 => $u], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $c, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/doctrine/common/lib/Doctrine/Common/Proxy/Autoloader.php';
        ...
        include_once \dirname(__DIR__, 3).'/vendor/doctrine/cache/lib/Doctrine/Common/Cache/Psr6/DoctrineProvider.php';
    ...
    {
        return $this->privates['App\\Security\\CSRFCookieListener'] = new \App\Security\CSRFCookieListener(($this->privates['App\\Security\\CSRFTokenManager'] ?? $this->getCSRFTokenManagerService()), [0 => '^/'], 'XSRF-TOKEN', 0, '/', NULL, false);
    }
    ...
    {
        return $this->privates['App\\Security\\CSRFValidationListener'] = new \App\Security\CSRFValidationListener(($this->privates['App\\Security\\CSRFTokenManager'] ?? $this->getCSRFTokenManagerService()), new \App\Security\RouteMatcher(), [], 'X-XSRF-TOKEN');
    }
    ...
    protected function getLegacySessionDenyAccessListenerService()
    {
        ...
        return $this->privates['App\\Security\\LegacySessionDenyAccessListener'] = new \App\Security\LegacySessionDenyAccessListener(new \ApiPlatform\Core\Security\EventListener\DenyAccessListener($a, $b), $a, $b, ($this->privates['App\\Authentication\\LegacyHandler\\Authentication'] ?? $this->getAuthenticationService()), ($this->services['session'] ?? $this->getSessionService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GFkxP4Ar1i', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DSUXL6tmri', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('doDFAF022U', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lt4VL3IkAz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PAAAAevYNH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getApiPlatform_ItemDataProviderService()
    {
        return $this->privates['api_platform.item_data_provider'] = new \ApiPlatform\Core\DataProvider\ChainItemDataProvider(new RewindableGenerator(function () {
            ...
            yield 6 => ($this->privates['App\\Navbar\\DataProvider\\NavbarItemDataProvider'] ?? $this->load('getNavbarItemDataProviderService'));
            yield 7 => ($this->privates['App\\Process\\DataProvider\\ProcessItemDataProvider'] ?? ($this->privates['App\\Process\\DataProvider\\ProcessItemDataProvider'] = new \App\Process\DataProvider\ProcessItemDataProvider()));
            yield 8 => ($this->privates['App\\Statistics\\DataProvider\\BatchedStatisticsItemDataProvider'] ?? $this->load('getBatchedStatisticsItemDataProviderService'));
            yield 9 => ($this->privates['App\\Statistics\\DataProvider\\StatisticsItemDataProvider'] ?? $this->load('getStatisticsItemDataProviderService'));
            yield 10 => ($this->privates['App\\SystemConfig\\DataProvider\\SystemConfigItemDataProvider'] ?? $this->load('getSystemConfigItemDataProviderService'));
            yield 11 => ($this->privates['App\\Themes\\DataProvider\\ThemeImagesItemDataProvider'] ?? $this->load('getThemeImagesItemDataProviderService'));
            yield 12 => ($this->privates['App\\UserPreferences\\DataProvider\\UserPreferenceItemDataProvider'] ?? $this->load('getUserPreferenceItemDataProviderService'));
            yield 13 => ($this->privates['App\\ViewDefinitions\\DataProvider\\ViewDefinitionItemDataProvider'] ?? $this->load('getViewDefinitionItemDataProviderService'));
            yield 14 => ($this->privates['api_platform.doctrine.orm.default.item_data_provider'] ?? $this->load('getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService'));
        }, 15));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('p7F0Yc4ywS', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Xc76m+QjYt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iNFhykzneC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iXWCz1rEjP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y+1fxv7Q9v', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sEtvBr0OHV', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bg0fB375Sr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'ApiPlatformBundle' => [
                    'path' => (\dirname(__DIR__, 3).'/vendor/api-platform/core/src/Bridge/Symfony/Bundle'),
            ...
            'system.settings' => [
                'setup_wizard_route' => 'users/set-timezone',
            ],
            'upgrades' => [
                'toKeep' => [
                    0 => 'cache',
                    1 => 'extensions',
                    2 => 'public/extensions',
                    3 => 'public/legacy/modules',
                    4 => 'public/legacy/custom',
                    5 => 'public/legacy/cache',
                    6 => 'public/legacy/upload',
                    7 => 'public/legacy/Api/V8/OAuth2/private.key',
                    8 => 'public/legacy/Api/V8/OAuth2/public.key',
                    9 => 'public/legacy/config.php',
                    10 => 'public/legacy/config_override.php',
                    11 => 'public/legacy/config_si.php',
                    12 => 'public/legacy/suitecrm.log',
                    13 => 'public/legacy/install.log',
                    14 => 'logs',
                    15 => '.env.local',
                    16 => '.env.local.php',
                    17 => 'tmp',
