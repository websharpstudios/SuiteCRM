...
class getViewDefinitionItemDataProviderService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\ViewDefinitions\\DataProvider\\ViewDefinitionItemDataProvider'] = new \App\ViewDefinitions\DataProvider\ViewDefinitionItemDataProvider(new \App\ViewDefinitions\LegacyHandler\ViewDefinitionsHandler(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'LEGACYSESSID', 'PHPSESSID', $a, $b, $c, new \App\ViewDefinitions\LegacyHandler\RecordViewDefinitionHandler(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'LEGACYSESSID', 'PHPSESSID', $a, $d, new \App\Data\Service\RecordActionDefinitionProvider($container->parameters['module.recordview.actions'], $e), $g, $h, $container->parameters['module.recordview.sidebar_widgets'], $container->parameters['module.recordview.top_widgets'], $f), new \App\ViewDefinitions\LegacyHandler\SubPanelDefinitionHandler(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'LEGACYSESSID', 'PHPSESSID', $a, $b, $c, new \App\Process\Service\SubpanelTopActionDefinitionProvider($container->parameters['module.subpanel.top_actions'], $container->parameters['module.subpanel.top_buttons'], $e), new \App\Process\Service\SubpanelLineActionDefinitionProvider($container->parameters['module.subpanel.line_actions'], $e), $h, $f), new \App\ViewDefinitions\LegacyHandler\ListViewDefinitionHandler(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'LEGACYSESSID', 'PHPSESSID', $a, $d, new \App\Process\Service\BulkActionDefinitionProvider($container->parameters['module.listview.bulk_action'], $e), $g, new \App\Process\Service\LineActionDefinitionProvider($container->parameters['module.listview.line_action'], ($container->privates['App\\Engine\\LegacyHandler\\AclHandler'] ?? $container->load('getAclHandlerService')), $c, $b, ($container->privates['App\\Languages\\LegacyHandler\\AppListStringsHandler'] ?? $container->load('getAppListStringsHandlerService'))), new \App\Filters\Service\FilterDefinitionProvider(($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService'))), $h, $f, $container->parameters['module.listview.sidebar_widgets']), ($container->privates['App\\ViewDefinitions\\LegacyHandler\\MassUpdateDefinitionHandler'] ?? $container->load('getMassUpdateDefinitionHandlerService')), $h, $d, new \App\ViewDefinitions\LegacyHandler\ViewDefinitionMappers(new RewindableGenerator(function () use ($container) {
