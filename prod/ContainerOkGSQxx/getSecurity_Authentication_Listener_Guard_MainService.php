...
class getSecurity_Authentication_Listener_Guard_MainService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/security-guard/Firewall/GuardAuthenticationListener.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/security-guard/GuardAuthenticatorHandler.php';
